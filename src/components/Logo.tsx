...
/**
 * FacialioLogo — Original pixel-grid SVG logo.
 * Blue cascading squares fading in opacity — face-scan grid motif.
 */
const FacialioLogo = ({ size = 40 }: { size?: number }) => {
  const scale = size / 40;
  return (
    <svg
      fill="none"
